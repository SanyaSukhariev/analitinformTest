          ...
          <div className={classes.informations}>
            ...
            <div className={classes.content}>
              <div className={classes.contentInfo}>
                ...
                <div>
                  <p>ТОВ «Аналітінформ» – це колектив професіоналів, який успішно працює на ринку кормових добавок  та ветеринарних препаратів України з 2018 року. </p>
                  <p>Основною сферою діяльності компанії є продаж сільськогосподарським підприємствам таких товарів як:</p>
                </div>
                <ul className={classes.itemsInfo}>
                  ...
                  <li> <strong> Амінокислоти </strong> для збалансування раціонів свиней та птиці: L-лізин, L-треонін, L-триптофан, L-метіонин, МНА (метіонінгідрокси аналог).</li>
